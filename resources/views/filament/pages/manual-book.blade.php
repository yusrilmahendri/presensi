<x-filament-panels::page>
    <div class="space-y-6">
                ...
                @foreach([
                    ...
                    <div class="flex items-start gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-700 dark:text-gray-400">{{ $item['desc'] }}</p>
                        </div>
                    </div>
                @endforeach
            </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <a href="{{ \App\Filament\Pages\FAQ::getUrl() }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                Lihat FAQ
                            </a>
                            <a href="{{ \App\Filament\Pages\Contact::getUrl() }}" class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition text-sm">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="text-center text-sm text-gray-500 dark:text-gray-400 py-4">
            <p>Manual Book Version 2.0 | Last Updated: {{ now()->format('d F Y') }}</p>
