...
<head>
    ...
    <title><?php echo e($user->organization->name ?? 'Sistem Presensi'); ?></title>
...
<body>
    <div class="container">
        <div class="attendance-card">
            <div class="d-flex justify-content-between align-items-center mb-4 header-section">
                <h2 class="mb-0"><?php echo e($user->organization->name ?? 'Sistem Presensi'); ?></h2>
                <div class="header-actions">
                    <a href="<?php echo e(route('karyawan.dashboard')); ?>" class="btn btn-sm btn-outline-primary">Dashboard</a>
                    <a href="<?php echo e(route('karyawan.profile')); ?>" class="btn btn-sm btn-outline-secondary">Profil</a>
            ...
            <p class="text-center text-muted mb-4">
                Masuk sebagai: <strong><?php echo e($user->name); ?></strong> (<?php echo e($user->email); ?>)
            </p>
    ...
    <script>
        ...
        // Get location
        const attendanceLocations = <?php echo json_encode($locations, 15, 512) ?>;
        let watchId = null;
        ...
        function initMap(lat, lng, accuracy) {
            ...
            if (!map) {
                ...
                L.circle([<?php echo e($location->latitude); ?>, <?php echo e($location->longitude); ?>], {
                    color: '#28a745',
                    fillColor: '#d4edda',
                    fillOpacity: 0.15,
                    radius: <?php echo e($location->radius); ?>

                }).addTo(map).bindPopup('<strong><?php echo e($location->name); ?></strong><br>Radius: <?php echo e($location->radius); ?>m');
        ...
        async function submitOvertimeRequest(attendanceId, reason) {
            try {
                ...
                const response = await fetch('<?php echo e(route("attendance.submit-overtime")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken,
