...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(collect($indicators)->contains(fn (\Filament\Tables\Filters\Indicator $indicator): bool => $indicator->isRemovable())): ?>
        <div class="mt-0.5">
...
<?php /**PATH /Users/mac/Documents/code/web/presensi/vendor/filament/tables/resources/views/components/filters/indicators.blade.php ENDPATH**/ ?>